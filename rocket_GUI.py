...
button_s = tk.Button(root, text="START", padx=30, pady=20, bg = "#93fa8c", command = lambda platform = "Epic", username = "filete_filete": scraper.start_session)
button_s.grid(row = 4, column= 0)

button_s = tk.Button(root, text = "STOP", padx=30, pady=20, bg = "#fa8c8c", command = scraper.end_session)
